...
<!DOCTYPE HTML>
<html>
<title>Normalised Results</title>
<meta charset="UTF-8">
...
<header id="header" class="w3-container w3-theme w3-padding">
    <div id="headerContentName"><font class="w3-center w3-theme"><h1>Get normalised results</h1></font></div>
</header>

<!-- <div class="dropdown">
	<button class="dropbtn">Select survey</button>
